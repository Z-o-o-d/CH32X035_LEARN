...
#define CHANGE_OPA_WATER_LEVEL 3500
/*********************************************************************
 * @fn      OPA2_Init
 *
...
int main(void)
{
    ...
    while(1)
    {
        ...
        if (ADC_val<CHANGE_OPA_WATER_LEVEL)
        {
            printf("OPA2_Change(CHN_PGA_32xIN)\r\n");
            printf("ADC_val:  %04d\r\n",2*ADC_val);
            break;
        }
        ...
        if (ADC_val<CHANGE_OPA_WATER_LEVEL)
        {
            printf("OPA2_Change(CHN_PGA_16xIN)\r\n");
            printf("ADC_val:  %04d\r\n",4*ADC_val);
            break;
        }
        ...
        if (ADC_val<CHANGE_OPA_WATER_LEVEL)
        {
            printf("OPA2_Change(CHN_PGA_8xIN)\r\n");
            printf("ADC_val:  %04d\r\n",8*ADC_val);
            break;
        }
        ...
        if (ADC_val<CHANGE_OPA_WATER_LEVEL)
        {
            printf("OPA2_Change(CHN_PGA_4xIN)\r\n");
            printf("ADC_val:  %04d\r\n",16*ADC_val);
            break;
        }
